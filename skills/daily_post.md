...
3. 蒐集每個商品的：**商品名稱**、**原價**、**優惠價**、**商品詳細介紹**，以及**至少 3 張真實吸引人的商品照片網址**（過濾並排除網站商標/Header Logo）。
   - **⚠️ 規格與容量標註鐵律**：如果商品有明顯的容量或包裝規格限制（例如：水果有克數/台斤如 500g、保養品或液體有 ml 數如 100ml、保溫瓶有容量如 400ml 等），**必須在商品名稱 name 後方以括號標註容量（例如：美國加州華盛頓櫻桃禮盒 (500g)）**，並在文案中同步寫明。這樣可以確保使用者 100% 掌握包裝容量，避免產生認知誤差！
